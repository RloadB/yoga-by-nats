  ...
  return (
    <section id="booking" className="bg-cream py-20 lg:py-32">
      <div className="site-container">
        <div className="bg-cream-dark px-8 py-14 md:px-14 lg:px-20 lg:py-20">
          <div className="max-w-2xl mx-auto text-center">

            <div className="w-8 h-px bg-terracotta/50 mx-auto mb-10" />

            <p className="font-sans text-terracotta text-[10px] tracking-[0.35em] uppercase mb-5">
              Join a session
            </p>
            <h2 className="font-serif text-4xl md:text-5xl lg:text-[58px] text-forest leading-[1.06] mb-7">
